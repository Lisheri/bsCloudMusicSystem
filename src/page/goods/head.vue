    ...
    <div class="head">
      ...
      <div class="avatar">
        ...
        >
          ...
          <ul class="userInfo" v-if="isLogin">
            <li class="myOrder" @click="goOrder">
              <i class="el-icon-document"></i>我的订单
            </li>
            <li class="myAddress" @click="goAddress">
              <i class="el-icon-position"></i>我的收货地址
            </li>
          </ul>
          <div v-else>请登录</div>
        </el-popover>
...
export default {
  ...
  data() {
    return {
      num: 0,
      isLogin: storage.get("_username_") ? true : false
    };
  },
  mounted() {
    bus.$on("goodNum", res => {
